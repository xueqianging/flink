...
/**
 * Tests for {@link KeyedStateInputFormat}.
 */
public class KeyedStateInputFormatTest {
	...
	public void testCreatePartitionedInputSplits() throws Exception {
		...
		KeyGroupRangeInputSplit[] splits = KeyedStateInputFormat.createInputSplits(4, operatorState);
	...
	public void testMaxParallelismRespected() throws Exception {
		...
		KeyGroupRangeInputSplit[] splits = KeyedStateInputFormat.createInputSplits(400, operatorState);
	...
	public void testRestoreKeyRangeInputSplit() throws Exception {
		...
		KeyGroupRangeInputSplit split = KeyedStateInputFormat.createInputSplits(1, operatorState)[0];

		AbstractKeyedStateBackend<Integer> backend = KeyedStateInputFormat.createAndRestoreKeyedStateBackend(
	...
	@Nonnull
	private List<Integer> readInputSplit(KeyGroupRangeInputSplit split, ProcessReaderFunction<Integer, Integer> userFunction) throws java.io.IOException {
		KeyedStateInputFormat<Integer, Integer> format = new KeyedStateInputFormat<>("", "uid", new MemoryStateBackend(), Types.INT, userFunction);
	...
	private OperatorSubtaskState createOperatorSubtaskState() throws Exception {
		try (KeyedOneInputStreamOperatorTestHarness<Integer, Integer, Void> testHarness = new KeyedOneInputStreamOperatorTestHarness<>(
