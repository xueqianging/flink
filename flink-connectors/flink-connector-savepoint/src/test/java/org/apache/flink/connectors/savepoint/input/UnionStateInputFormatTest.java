...
/**
 * Tests for {@link UnionStateInputFormat}.
 */
public class UnionStateInputFormatTest {
	...
	public void testReadUnionOperatorState() throws Exception {
		try (OneInputStreamOperatorTestHarness<Integer, Void> testHarness = new OneInputStreamOperatorTestHarness<Integer, Void>(
			...
			UnionStateInputFormat<Integer> format = new UnionStateInputFormat<>("", "uid", descriptor);
