...
/**
 * A streaming {@link RuntimeContext} which delegates to the underlying
 * batch {@code RuntimeContext} along with a specified {@link KeyedStateStore}.
 *
 * <p>This {@code RuntimeContext} can limit user's ability to register
 * state descriptors to force eager state declaration.
 */
@Internal
final public class SavepointRuntimeContext implements RuntimeContext {
