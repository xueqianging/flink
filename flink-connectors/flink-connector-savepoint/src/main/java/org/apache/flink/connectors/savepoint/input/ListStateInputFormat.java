 ...
 */
@PublicEvolving
public class ListStateInputFormat<O> extends OperatorStateInputFormat<O> {
	 ...
	 */
	public ListStateInputFormat(String savepointPath, String uid, ListStateDescriptor<O> descriptor) {
