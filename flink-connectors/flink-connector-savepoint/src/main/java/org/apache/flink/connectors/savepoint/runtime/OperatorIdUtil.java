 ...
 */
@Internal
public final class OperatorIdUtil {
	private OperatorIdUtil() {}

	private static final Hasher hasher = Hashing.murmur3_128(0).newHasher();
	...
	public static OperatorID operatorIDFromUID(String uid) {
		byte[] hash = hasher.putString(uid, UTF_8).hash().asBytes();
