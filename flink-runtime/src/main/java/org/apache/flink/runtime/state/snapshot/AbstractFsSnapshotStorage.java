 ...
 * Examples that inherit from this are the {@link FileSystemStorage}, the
 * {@link JobManagerStorage}.
 *
 ...
 */
public abstract class AbstractFsSnapshotStorage implements SnapshotStorage {
	 ...
	 */
	protected AbstractFsSnapshotStorage(@Nullable String baseCheckpointPath) {
	 ...
	 * @param baseCheckpointPath The base directory for checkpoints, or null, if none is configured.
	 */
	protected AbstractFsSnapshotStorage(@Nullable URI baseCheckpointPath) {
		this(baseCheckpointPath == null ? null : new Path(baseCheckpointPath));
	}
	 ...
	 * @param baseCheckpointPath The base directory for checkpoints, or null, if none is configured.
	 */
	protected AbstractFsSnapshotStorage(@Nullable Path baseCheckpointPath) {
	 ...
	 */
	protected AbstractFsSnapshotStorage(
		@Nullable Path baseCheckpointPath,
		@Nullable Path defaultSavepointPath,
		ReadableConfig configuration) {

		this(parameterOrConfigured(baseCheckpointPath, configuration, CheckpointingOptions.CHECKPOINTS_DIRECTORY),
			parameterOrConfigured(defaultSavepointPath, configuration, CheckpointingOptions.SAVEPOINT_DIRECTORY));
	}

	private AbstractFsSnapshotStorage(@Nullable Path baseCheckpointPath, @Nullable Path defaultSavepointLocation) {
		this.baseCheckpointPath = baseCheckpointPath;
		this.baseSavepointPath = defaultSavepointLocation;
	}
