...
public class ExecutionConfig implements Serializable, Archiveable<ArchivedExecutionConfig> {
	...
	private boolean disableAutoGeneratedUid = false;
	 ...
	 * a job, specifying custom ID's allow an application to evolve overtime
	 * without discarding state.
	 */
	public void  disableAutoGeneratedUIDs() {
		disableAutoGeneratedUid = true;
	}

	/**
	 * Checks whether auto generated UID's are supported.
	 *
	...
	public boolean hasAutoGeneratedUIDsDisabled() {
		return disableAutoGeneratedUid;
	}
