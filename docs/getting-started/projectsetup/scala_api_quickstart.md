...
take a look at the [Stream Processing Application Tutorial]({{ site.baseurl }}/getting-started/walkthroughs/datastream_api.html#writing-a-flink-program)
...
[Here]({{ site.baseurl }}/ops/deployment/local_setup.html) you can find out how to run an application outside the IDE on a local cluster.
