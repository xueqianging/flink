...
refer to the [Java API]({{ site.baseurl }}/getting-started/projectsetup/java_api_quickstart.html)
and the [Scala API]({{ site.baseurl }}/getting-started/projectsetup/scala_api_quickstart.html)
quickstart guides.
