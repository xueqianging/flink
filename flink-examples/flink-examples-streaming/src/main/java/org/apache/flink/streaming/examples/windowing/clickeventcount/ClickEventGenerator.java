...
public class ClickEventGenerator {
	...
	private static Map<String, Long> nextTimestampPerKey = new HashMap<>();
	...
	public static void main(String[] args) throws Exception {
		...
		while (true) {
			...
			ClickEvent event = new ClickEvent(nextTimestamp(page), page);
	...
	public static long nextTimestamp(String page) {
		...
		nextTimestampPerKey.put(page, nextTimestamp + TimeUnit.MINUTES.toMillis(1) / EVENTS_PER_WINDOW);
