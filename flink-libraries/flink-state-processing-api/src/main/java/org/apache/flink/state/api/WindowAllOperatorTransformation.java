...
public class WindowAllOperatorTransformation<T, W extends Window> {
	...
	private final KeySelector<T, Byte> keySelector;

	WindowAllOperatorTransformation(
		DataSet<T> input,
	 ...
	 */
	@PublicEvolving
	public WindowAllOperatorTransformation<T, W> trigger(Trigger<? super T, ? super W> trigger) {
	 ...
	 */
	@PublicEvolving
	public WindowAllOperatorTransformation<T, W> evictor(Evictor<? super T, ? super W> evictor) {
