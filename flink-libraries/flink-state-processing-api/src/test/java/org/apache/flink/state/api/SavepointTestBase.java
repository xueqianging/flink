 ...
 */
abstract class SavepointTestBase extends AbstractTestBase {

	<T> String takeSavepoint(Collection<T> data, Function<SourceFunction<T>, StreamExecutionEnvironment> jobGraphFactory) throws Exception {
